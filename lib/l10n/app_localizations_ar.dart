...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get settingsTrialActive => 'Feloosy Pro تجريبي';
  ...
  String paywallTrialBanner(int days) {
    return 'وضع التجربة · $days أيام متبقية';
  }
  ...
  @override
  String get batteryOptTitle => 'لا تفوّت المعاملات';

  @override
  String get batteryOptBody =>
      'بدون هذا، قد لا يتم استيراد بعض رسائل البنك حتى تفتح التطبيق مجدداً.';
